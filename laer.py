    ...
    if h1 == "0":
        ...
        while True:
            ...
            if h11 == "0":
                ...
                h9 = input("面色:")
                h10 = input("线色:")              
                c1,c2,c3 = [int(h10[h:h+2], 16) for h in (0, 2, 4)]
                c4 = int(c1 * 0.75)
                c5 = int(c2 * 0.75)
                c6 = int(c3 * 0.75)
                c7,c8,c9 = [int(h10[h:h+2], 16) for h in (0, 2, 4)]
                c10 = int(c7 * 0.75)
                c11 = int(c8 * 0.75)
                c12 = int(c9 * 0.75)
                h5[h7] = [c1,c2,c3,c7,c8,c9,c4,c5,c6,c10,c11,c12]               
                print(f"[{h11}]{h5[h7]}")
                h6[h7] = h8               
                with open(h3, 'w', encoding="utf-8") as file:
        ...
        try:
            ...
            h16 = [[[1 for _ in range(16)]for _ in range(16)]for _ in range(16)]
        ...
        for v2, v3, v4 in os.walk(v1):
            ...
            v6 = '|   ' * v5
            print(f'{h6}[{os.path.basename(v2)}]')
            v7 = '|   ' * (v5 + 1)
            for v8 in v4:
                print(f'{v7}{v8}')
    else:
